...
export default function Footer() {
  return (
    <footer className="bg-[oklch(0.12_0_0)] text-white/80">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed mb-4">
              ...
              counties. If you want it gone, consider it gone.
            </p>
            <div className="flex gap-3">
              <a
                href="https://www.facebook.com/profile.php?id=61565693023903"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Follow us on Facebook"
                className="p-2 rounded-md bg-white/10 hover:bg-primary hover:text-primary-foreground transition-colors"
              >
                <FacebookIcon className="h-5 w-5" />
              </a>
              <a
                href="https://www.instagram.com/longslandmanagement/"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div>
            ...
            <div className="mt-4 pt-4 border-t border-white/10">
              <p className="text-xs text-white/50">
                We accept Visa, Mastercard, AmEx, Discover, PayPal, and checks.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row justify-between items-center gap-2 text-xs text-white/40">
          <p>&copy; {new Date().getFullYear()} Long&apos;s Land Management. All rights reserved.</p>
          <p>Serving Central Florida with pride.</p>
        </div>
      </div>
    </footer>
  );
